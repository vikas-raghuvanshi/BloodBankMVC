<%-- 
    Document   : donate
    Created on : Mar 9, 2024, 9:19:44 PM
                    ...
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.5s">
                        <form action="DonationReqChecker" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="number" name="age" class="form-control" id="age" placeholder="Age" max="100" min="18" oninvalid="this.setCustomValidity('Please enter age between 18-150.')" oninput="this.setCustomValidity('')" required>
