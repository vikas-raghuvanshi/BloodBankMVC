<%-- 
    ...
    Created on : Mar 23, 2024, 12:03:05 PM
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
            <div class="container text-center py-5">
                <h1 class="display-4 text-white animated slideInDown mb-3">Patients Requests</h1>
                    ...
                    <tbody>
                        <%
                            try {
                                ...
                                String query = "Select aadhaar_no,username,FinalAge,gender,bgroup,address,contact,FinalUnits from patient_request";
