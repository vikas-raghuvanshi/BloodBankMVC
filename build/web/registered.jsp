<%-- 
    Document   : registered
    Created on : Mar 16, 2024, 9:27:28 PM
...
<body>
    ...
    <%
        String aadhar = (String) session.getAttribute("aadhaar");
        ...
        <div class="container text-center">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">We have successfully registered your request.We will update you as soon as possible</p>
