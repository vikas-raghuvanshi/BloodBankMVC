<%-- 
    Document   : receivers
    Created on : Mar 22, 2024, 5:08:42 PM
                    ...
                    <tbody>
                        <%
                            try {
                               ...
                               String query = "Select pid,aadhaar_no,name,age,gender,blood_group,address,contact,units_required,units_given from request_completed";
