<%-- 
    Document   : webhome
    Created on : Mar 9, 2024, 4:41:43 PM
...
<head>
    <meta charset="utf-8">
    <title>Blood Bank Web page</title>
...
<!--                <a href="process.jsp" class="nav-item nav-link">Team</a>       PROJECT-->
                    ...
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.5s">
                        <form action="DonationReqChecker" method="post">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <input type="number" name="age" class="form-control" id="age" placeholder="Age" max="100" min="18" oninvalid="this.setCustomValidity('Please enter age between 18-100.')" oninput="this.setCustomValidity('')" required>
...
<!--                    <a class="btn btn-link" href="process.jsp">Team</a>-->
                    <a class="btn btn-link" href="login.jsp">Administration Login</a>
                </div>
<!--                <div class="col-lg-3 col-md-6">
    ...
    <script>
        ...
        function InvalidMsgAadhar(textbox){
            if(textbox.validity.patternMismatch){
                textbox.setCustomValidity('Please enter 12 digit Aadhar Number');
            }
            else{
